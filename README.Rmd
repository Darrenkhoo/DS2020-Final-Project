...
These graphs are just general histograms for the distributions of Benign and Malignant Cancer for all of the columns. We noticed that the graph with the biggest separation of benign and malignant was the `concave points_worst`, but when creating a diagnosis it is unrealistic to be able to use this as a variable because the only way to find a `*_worst` would be to check each and every cancer cell, which is unrealistic in a real life situation.
